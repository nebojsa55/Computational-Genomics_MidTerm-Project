...
*DISCLAIMER*:
**The challenge ended in 2019. and this implementation was not an active part of the challenge**
...
**EDIT**
5. [Final-model.ipybn](https://github.com/nebojsa55/Computational-Genomics_MidTerm-Project/blob/master/notebooks/5.%20Final-model.ipynbl) 
   ...
   - RMSE(EN) = **5.0400** :heavy_check_mark:
